...
class TestFunWithTemplates < FunWith::Templates::TestCase
  context "run test templates and validate results" do
    ...
    should "validate results of template00" do
      @dest = TemplateEvaluator.evaluate_dir( @template_00, :temp, 
        { :module => "Racer", 
          :class => "Car", 
    ...
    should "build templates/epubforge" do
      vars = {
        :book => {
      ...
      dest = FunWith::Templates::TemplateEvaluator.evaluate_dir( @template_epf, :temp, vars )
